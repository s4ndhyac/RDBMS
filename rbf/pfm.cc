...
//	std::fstream pageFile(fileName, std::ios::app | std::ios::binary | std::ios::in | std::ios::out);
	FILE* pageFile;
 ...
 * @param fileHandle : file handle object used to point to fileName. The file handle object should not point to any another file.
